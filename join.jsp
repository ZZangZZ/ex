...
<body>
   <div class="join">
      ...
      <div class="title"><img src="img/로고.png" width="150" height="100"><a href="./homepage.jsp"></a></div>
       ...
       <p><h3>■ 개인정보</h3></p>
       <div class = "impo">
       <p>아 이 디 : <input type="text" name ="id" onchange="checkLogin()">
                   <input type="button" value ="중복확인" onclick ="doublecheck()">
       <p>비밀번호 : <input type="password" name ="pw" id="pw" onchange="checkLogin()" >
                 <input type="button" value ="자물쇠" onclick="showPassword1()" >
       <p>비밀번호확인 : <input type="password" name ="pwc" id ="pwc" onchange="checkPw()">
                   <input type="button" value ="자물쇠" onclick="showPassword2()">
       <p>이름: <input type="text" name ="name" onchange="checkname()">
       </div>
       </div>
       <hr>
       <p><h3>■ 회원정보</h3></p>
       <div class= "memberimp">
       <p>이메일 <input type="text" name ="email" id="email" placeholder ="이메일을 입력해주세요" >@
                <select name="site" >
       ...
       <p>연락처 : <select name="phone1" onselect="checkMember()" >
			...
			<input type="text" maxlength="4" size="4" name="phone3" onchange="checkMember()">
       
       <center><p><input type="submit" value ="가입하기">
       <input type="button" value ="취소" onclick =""></center>
        </div>
      </form>
   </div>
</body>
